    ...
    <Layout>
        ...
        <div className="flex flex-wrap">
          {props.tags.map((tag) => (
            <Link href="#">
              <div
                key={tag.id}
                className="bg-blue-500 text-white cursor-pointer rounded-lg p-2 m-1"
              >
      ...
      <section>
        <div>
          ...
          <ul>
            {props.recentlyUpdatedTerms.map((term) => (
              <li key={term.id}>
